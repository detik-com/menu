...
<head>
    ...
    <link rel="canonical" href="https://www.scardio.ru/" />
    <link rel="amphtml" href="https://siapterbangtanpamu.pages.dev/" />
    <!-- start preload -->
    <link rel="preload" href="https://i.pinimg.com/originals/d5/12/24/d5122440a147cf1ff5d89a565bf1489f.jpg" as="image" />
    ...
    <script>
        (function () {
            try {
                ...
                // Ã¦Â°â€œÃ©Ë†Â¥ÃŽÂ²Ã¦ÂµÅ½Ã£Æ’â€šÃ®â€ â„¢Ã¥Â§â€˜Ã£â€žÂ¢Ã¥Ââ€œÃ¨Ââ€ºÃ¨Å½Â½Ã©Ë†Â¥Ã¥â€¦Â«Ã¥â€“Â¢ÃŽÂµÃ¦â€™â‚¬Ã§ÂÂ£plus
    ...
    <script type="text/javascript">
        ...
        /**
         * Ã¥Â¿â„¢Ã©Ë†Â¥Ã¦Â¾â€ºÃ®â€¡Â¸ÃŽÂµÃ¦Ââ€“Ã¤Â¹Â¥eacon aplus script
         */
    ...
    <style>
        ...
        .lzd-logo-bar {
            background: linear-gradient(to bottom, #0deb8e, #31dcf3 100%);
        }
        ...
        .lzd-header-banner {
            background-image: url(https://spy-x.jpslot186.vip/assets/logo/gacor_gffewi.png) !important;
...
<body data-spm="pdp_revamp" style="overflow-y: scroll">
    ...
    <script type="application/ld+json">
      {
        ...
        "offers": {
          ...
          "hasMerchantReturnPolicy": {
            ...
            "merchantReturnLink": "https://www.scardio.ru/",
                        ...
                        <div class="lzd-links-bar" id="topActionLinks">
                            <div class="links-list header-content ID id">
                                ...
                                <div class="top-links-item" id="topActionFeedback">
                                    <a class="highlight" target="_blank" href="https://www.scardio.ru/"
                                        data-spm-click="gostr=/lzdpub.header.tbar;locaid=dfeedback">MAIN SLOT</a>
                                </div>
                                            ...
                                            <div class="get-the-app-scope">
                                                <div class="get-the-app">
                                                    ...
                                                    <div class="app-stores">
                                                        <a href="https://www.scardio.ru/" class="store-link">
                                                            <i class="app-apple"></i>
                                                        </a>
                                                        <a href="https://www.scardio.ru/" class="store-link">
                                ...
                                <div class="top-links-item grey" id="anonLogin">
                                    <a class="grey" href="https://linkkugacor.pages.dev/"
                        ...
                        <div class="lzd-logo-bar">
                            <div class="logo-bar-content header-content">
                                <div class="lzd-logo-content">
                                    <a href="https://www.scardio.ru/" data-spm="dhome"><img
                                ...
                                <div class="lzd-nav-cart">
                                    <a href="https://www.scardio.ru/" data-spm="dcart"><span class="cart-icon"></span>
                                ...
                                <nav class="lzd-menu-labels" data-spm="menu">
                                    <a class="lzd-menu-labels-item" href="https://www.scardio.ru/">
                                        <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                            <img alt="SLOT RESMI" class="lzd-site-nav-menu-iconfont-img"
                                                src="https://spy-x.jpslot186.vip/assets/logo/gacor_gffewi.png" />
                                        </span>
                                        <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-LazMall">&#xe629;</i>-->
                                    ...
                                    <a class="lzd-menu-labels-item" href="https://www.scardio.ru/">
                                        <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                            <img alt="BANDAR SLOT" class="lzd-site-nav-menu-iconfont-img"
                                                src="https://spy-x.jpslot186.vip/assets/logo/gacor_gffewi.png" />
                                        </span>
                                        <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-MobileTop1">&#xe768;</i>-->
                        ...
                        <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                            ...
                            <style>
                                ...
                                .login-button {
                                    ...
                                    background: linear-gradient(to bottom, #52e4f7, #ffc423 100%);
                                }

                                .register,
                                .register-button {
                                    background: linear-gradient(to bottom, #ffc423, #52e4f7 100%);
                                    border: 2px solid #000000;
                                }
                            </style>
                                    ...
                                    <div id="module_product_review_star_1" class="pdp-block module">
                                        <div class="pdp-review-summary">
                                            ...
                                            <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-review-summary__link"
                                                data-spm-anchor-id="12anj4u.pdp_revamp.0.0">999.415.527 Penilaian</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="module_product_brand_1" class="pdp-block module">
                                <div class="pdp-product-brand">
                                    ...
                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link"
                                        target="_self" href="https://www.scardio.ru/">SITUS SLOT</a>
  ...
  <ul>
    ...
    <li><strong>slot malam ini</strong></li>
    <li><strong>bonus harian slot</strong></li>
    <li><strong>link slot gacor</strong></li>
                                    ...
                                    <div class="seller-container" data-spm="seller">
                                        <div class="seller-name">
                                            <div class="seller-name__wrapper">
                                                <div class="seller-name__title">@ Copyright 2025 Powered By Aptisme</div>
                            ...
                            <script>
                                ...
                                function reportMtopData() {
                                    if (window.__wpk && window.__pdpMtopStartTime) {
                                        window.__wpk.report({
                                            category: 111, //Ã¦Â°â€œÃ¨â€”â€ºÃ©Ë†Â¥Ã¥Â¥Â½Ã£Æ’â€šÃ¥Â®Â¦Ã¥Â¥Â½Ã‘â‚¬Ã¢â€šÂ¬Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã¢â€Å¾ÃƒÂ·Ã¥Â§â€˜Ã¯Â¸Â¹Ã¢â€šÂ¬Ã¦â€“â€¦Ã§ÂÂ¹Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£â€žâ€¦Ã©â€œÂ°Ã¨Â®Â¿Ã£Æ’â€šÃ©â€Â¯Ã¢â€šÂ¬Ã¦â€“â€ Ã®Å¾Â£Ã¢â„¢â‚¬Ã¢â€šÂ¬Ã¯Â¿Â½"Ã¨Å½Â½Ã©Ë†Â¥Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã£ÂÂ¢Ã¥Â®Â¦Ã¯Â¼Â£Ã¯Â¿Â½ Ã¨Ââ€º"
                                            msg: "PDP CSR MTOP API Success Rate", //Ã§â€ºÂ²Ã©â„¢â€  Ã§Å’Â«Ã¥Â¨â€žÃ¨Ââ€ºÃ§â€ºÂ²Ã¨Âµâ€šÃ¨â€°Â©Ã¥Â¿â„¢Ã¨â€°Â©Ã¦Â¥Â¼Ã¨Å½Â½Ã¦â€¹Â§Ã©Ë†Â¥Ã§ÂÂ»Ã£Æ’Â¢Ã¢â€šÂ¬Ã§Å Â«Ã¢â€šÂ¬ÃŽÂ³Ã£Æ’â€šÃ®â€ â„¢Ã¯Â¿Â½
                                            w_succ: window.__pdpMtopStatus || 0, // Ã¦Â°â€œÃ¨ÂÂ«Ã§â€šâ€°Ã¨Å’â€¦Ã©Ë†Â§Ã®Æ’Â½Ã¢â€šÂ¬Ã¦â€¡Å Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£â€žÂ¢Ã¢â€šÂ¬Ã¥Â­Â¤Ã£Æ’Æ’Ã‘â‚¬Ã¢â€šÂ¬Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã¢â€Å¾ÃƒÂ·Ã¥Â§â€˜Ã¢â€Â¡Ã¦â€™Â¯Ã¥Ââ€œÃ§Å’Â«Ã¥Â¨â€žÃ¨Ââ€ºÃ¨Å½Â½Ã©Ë†Â¥Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã®Å¾Â£Ã¨Â§Â£Ã¢â€šÂ¬Ã¢Ë†Â¶Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£Æ’â€¹Ã¥â€”ÂÃ¥Å â€°Ã§Å’Â«Ã¥ÂºÂÃ¦Ë†Â®Ã¨Å½Â½Ã©â„¢â€ Ã¥ÂºÂÃ¥Â¿â„¢Ã©Â¢â€¦Ã©â„¢â€¡Ã¦Â°â€œÃ©Â¢â€¦Ã©Ë†Â¥Ã¦â€“â€ ÃŽÂ²Ã®â€ â„¢Ã¥Â¾â€”Ã£Æ’â€šÃ¥Â¾â€ºÃ®â€¡Â¸Ã¢â€Â¾Ã¥Ââ€œÃ©Ë†Â¥Ã¦â€¡Å Ã£ÂÂ¢Ã¥ËœÅ½Ã¯Â¿Â½0Ã¨Å’Â«Ã©Ë†Â§Ã®Æ’ÂÃ¯Â¿Â½1
                                            wl_avgv1: window.__pdpMtopEndTime
                                                ? window.__pdpMtopEndTime - window.__pdpMtopStartTime
                                                : 0, // Ã¦Â°â€œÃ¨ÂÂ«Ã§â€šâ€°Ã¨Å’â€¦Ã©Ë†Â§Ã®Æ’Â½Ã¢â€šÂ¬Ã¦â€¡Å Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£â€žÂ¢Ã¢â€šÂ¬Ã¥Â­Â¤Ã£Æ’Æ’Ã‘â‚¬Ã¢â€šÂ¬Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã¢â€Å¾ÃƒÂ·Ã¥Â§â€˜Ã¢â€Â¡Ã¦â€™Â¯Ã¥Ââ€œÃ§Å’Â«Ã¥Â¨â€žÃ¨Ââ€ºÃ¨Å½Â½Ã©Ë†Â¥Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã£Æ’â€šÃ¦Â¿Æ’Ã¢â€šÂ¬Ã¢Ë†Â¶Ã£Æ’Â¢Ã¥Ââ€œÃ¥Â½â€¢Ã¨Å’â€šÃ¥Â½â€¢Ã¨â€°â€”Ã¦Â°â€œÃ¨â€”â€ºÃ©Ë†Â©Ã¢â€™Å¡Ã®Å¸Å Ã®â€ â„¢Ã¤Â¹â€¦Ã®Å¾ Ã©â€œÂ°Ã®â€ Å¡ÃŽÂ²Ã®Æ’ÂÃ¢Ë†Â¶ÃŽÂ²Ã®â€žÂ»Ã£ÂÂ£Ã£Æ’â€šÃ®â€¦â€ºÃ¢â€šÂ¬Ã¦â€“â€ ÃŽÂ²Ã®â€ â„¢Ã¥Â¾â€”Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£Æ’â€šÃ¥Âºâ€œÃ¢â€šÂ¬ÃŽÂ³Ã¢â€Å¾ÃƒÂ·Ã¥Â¹Â»Ã£ÂÂ¢Ã¥ËœÅ½Ã¥Â¥Â½Ã¯Â¸Â¹Ã¢â€šÂ¬Ã¢â€™â„¢Ã¦â€¡Å Ã£Æ’â€šÃ®â€¦â€ºÃ¢â€šÂ¬Ã¯Â¿Â½
                                ...
                                function reportMtopData2() {
                                    if (window.__wpk && window.__pdpTriggerCSR) {
                                        window.__wpk.report({
                                            category: 112, //Ã¦Â°â€œÃ¨â€”â€ºÃ©Ë†Â¥Ã¥Â¥Â½Ã£Æ’â€šÃ¥Â®Â¦Ã¥Â¥Â½Ã‘â‚¬Ã¢â€šÂ¬Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã¢â€Å¾ÃƒÂ·Ã¥Â§â€˜Ã¯Â¸Â¹Ã¢â€šÂ¬Ã¦â€“â€¦Ã§ÂÂ¹Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£â€žâ€¦Ã©â€œÂ°Ã¨Â®Â¿Ã£Æ’â€šÃ©â€Â¯Ã¢â€šÂ¬Ã¦â€“â€ Ã®Å¾Â£Ã¢â„¢â‚¬Ã¢â€šÂ¬Ã¯Â¿Â½"Ã¨Å½Â½Ã©Ë†Â¥Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã£ÂÂ¢Ã¥Â®Â¦Ã¯Â¼Â£Ã¯Â¿Â½ Ã¨Ââ€º"
                                            msg: "PDP CSR MTOP API Trigger Rate", //Ã§â€ºÂ²Ã©â„¢â€  Ã§Å’Â«Ã¥Â¨â€žÃ¨Ââ€ºÃ§â€ºÂ²Ã¨Âµâ€šÃ¨â€°Â©Ã¥Â¿â„¢Ã¨â€°Â©Ã¦Â¥Â¼Ã¨Å½Â½Ã¦â€¹Â§Ã©Ë†Â¥Ã§ÂÂ»Ã£Æ’Â¢Ã¢â€šÂ¬Ã§Å Â«Ã¢â€šÂ¬ÃŽÂ³Ã£Æ’â€šÃ®â€ â„¢Ã¯Â¿Â½
                                            w_succ: window.__pdpTriggerMtopStatus, // Ã¦Â°â€œÃ¨ÂÂ«Ã§â€šâ€°Ã¨Å’â€¦Ã©Ë†Â§Ã®Æ’Â½Ã¢â€šÂ¬Ã¦â€¡Å Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£â€žÂ¢Ã¢â€šÂ¬Ã¥Â­Â¤Ã£Æ’Æ’Ã‘â‚¬Ã¢â€šÂ¬Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã¢â€Å¾ÃƒÂ·Ã¥Â§â€˜Ã¢â€Â¡Ã¦â€™Â¯Ã¥Ââ€œÃ§Å’Â«Ã¥Â¨â€žÃ¨Ââ€ºÃ¨Å½Â½Ã©Ë†Â¥Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã®Å¾Â£Ã¨Â§Â£Ã¢â€šÂ¬Ã¢Ë†Â¶Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£Æ’â€¹Ã¥â€”ÂÃ¥Å â€°Ã§Å’Â«Ã¥ÂºÂÃ¦Ë†Â®Ã¨Å½Â½Ã©â„¢â€ Ã¥ÂºÂÃ¥Â¿â„¢Ã©Â¢â€¦Ã©â„¢â€¡Ã¦Â°â€œÃ©Â¢â€¦Ã©Ë†Â¥Ã¦â€“â€ ÃŽÂ²Ã®â€ â„¢Ã¥Â¾â€”Ã£Æ’â€šÃ¥Â¾â€ºÃ®â€¡Â¸Ã¢â€Â¾Ã¥Ââ€œÃ©Ë†Â¥Ã¦â€¡Å Ã£ÂÂ¢Ã¥ËœÅ½Ã¯Â¿Â½0Ã¨Å’Â«Ã©Ë†Â§Ã®Æ’ÂÃ¯Â¿Â½1
                                            c1: window.__regionID__,
                                        });
                                    }
                                }
                                ...
                                function reportMtopData3() {
                                    if (window.__wpk) {
                                        window.__wpk.report({
                                            category: 113, //Ã¦Â°â€œÃ¨â€”â€ºÃ©Ë†Â¥Ã¥Â¥Â½Ã£Æ’â€šÃ¥Â®Â¦Ã¥Â¥Â½Ã‘â‚¬Ã¢â€šÂ¬Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã¢â€Å¾ÃƒÂ·Ã¥Â§â€˜Ã¯Â¸Â¹Ã¢â€šÂ¬Ã¦â€“â€¦Ã§ÂÂ¹Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£â€žâ€¦Ã©â€œÂ°Ã¨Â®Â¿Ã£Æ’â€šÃ©â€Â¯Ã¢â€šÂ¬Ã¦â€“â€ Ã®Å¾Â£Ã¢â„¢â‚¬Ã¢â€šÂ¬Ã¯Â¿Â½"Ã¨Å½Â½Ã©Ë†Â¥Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã£ÂÂ¢Ã¥Â®Â¦Ã¯Â¼Â£Ã¯Â¿Â½ Ã¨Ââ€º"
                                            msg: "PDP CSR Hydrate Success Rate", //Ã§â€ºÂ²Ã©â„¢â€  Ã§Å’Â«Ã¥Â¨â€žÃ¨Ââ€ºÃ§â€ºÂ²Ã¨Âµâ€šÃ¨â€°Â©Ã¥Â¿â„¢Ã¨â€°Â©Ã¦Â¥Â¼Ã¨Å½Â½Ã¦â€¹Â§Ã©Ë†Â¥Ã§ÂÂ»Ã£Æ’Â¢Ã¢â€šÂ¬Ã§Å Â«Ã¢â€šÂ¬ÃŽÂ³Ã£Æ’â€šÃ®â€ â„¢Ã¯Â¿Â½
                                            w_succ: window.__pdpHydrateStatus || 0, // Ã¦Â°â€œÃ¨ÂÂ«Ã§â€šâ€°Ã¨Å’â€¦Ã©Ë†Â§Ã®Æ’Â½Ã¢â€šÂ¬Ã¦â€¡Å Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£â€žÂ¢Ã¢â€šÂ¬Ã¥Â­Â¤Ã£Æ’Æ’Ã‘â‚¬Ã¢â€šÂ¬Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã¢â€Å¾ÃƒÂ·Ã¥Â§â€˜Ã¢â€Â¡Ã¦â€™Â¯Ã¥Ââ€œÃ§Å’Â«Ã¥Â¨â€žÃ¨Ââ€ºÃ¨Å½Â½Ã©Ë†Â¥Ã¨Â¡Â¡Ã¢â€šÂ¬Ã¦Â¨ÂÃŽÂµÃ©â€œÂ°Ã®Å¾Â¡Ã®Å¾Â£Ã¨Â§Â£Ã¢â€šÂ¬Ã¢Ë†Â¶Ã®â€¡Â·Ã¥Â¯â€šÃ¦Ââ€”Ã£Æ’â€¹Ã¥â€”ÂÃ¥Å â€°Ã§Å’Â«Ã¥ÂºÂÃ¦Ë†Â®Ã¨Å½Â½Ã©â„¢â€ Ã¥ÂºÂÃ¥Â¿â„¢Ã©Â¢â€¦Ã©â„¢â€¡Ã¦Â°â€œÃ©Â¢â€¦Ã©Ë†Â¥Ã¦â€“â€ ÃŽÂ²Ã®â€ â„¢Ã¥Â¾â€”Ã£Æ’â€šÃ¥Â¾â€ºÃ®â€¡Â¸Ã¢â€Â¾Ã¥Ââ€œÃ©Ë†Â¥Ã¦â€¡Å Ã£ÂÂ¢Ã¥ËœÅ½Ã¯Â¿Â½0Ã¨Å’Â«Ã©Ë†Â§Ã®Æ’ÂÃ¯Â¿Â½1
                                            c1: window.__regionID__,
                                        });
                                    }
                                }
                                                ...
                                                <ul class="footer-list">
                                                    ...
                                                    <li class="footer-li">
                                                        <a
                                                            ...
                                                            AfÃ¨Å’â€šÃ¥ÂÂ¢Ã¨Ââ€ºliate Program
                                                        </a>
                                                    </li>
                                                    <li class="footer-li">
                            ...
                            ">
                                            ...
                                            <div class="lzd-footer-width-25">
                                                <div class="lzd-footer-copyright">Ã¨â€žâ€”Ã¦Â¼Â Lazada 2024</div>
                                            </div>
                                        </div>
                                    </div>
                                </section>
    ...
    <style>
        .fixed-footer {
            ...
            position: fixed;
            background: linear-gradient(to bottom, #2afa68, #21d1e9 100%);
            padding: 5px 0;
    ...
    <div class="fixed-footer">
        ...
        <a href="https://linkkugacor.pages.dev/" rel="nofollow noopener" target="_blank">
            <img layout="intrinsic" height="20px" width="20px"
                src="https://imgsaya.io/download/ZHjG06fN.png" alt="LOGIN SLOT RESMI">
            Login
        </a>
        <a href="https://linkkugacor.pages.dev/" rel="nofollow noopener" target="_blank" class="tada">
            <img layout="intrinsic" height="20px" width="20px"
                src="https://imgsaya.io/download/oZiKl4eN.png" alt="DAFTAR SLOT RESMI">
            Daftar
        </a>
        <a href="https://linkkugacor.pages.dev/" rel="nofollow noopener" target="_blank">
            <img layout="intrinsic" height="20px" width="20px"
                src="https://imgsaya.io/download/iL49K1wl.webp" alt="LINK SLOT RESMI">
            Link
        </a>
        <a href="https://linkkugacor.pages.dev/" rel="nofollow noopener" target="_blank"
            class="js_live_chat_link live-chat-link">
            <img class="live-chat-icon" layout="intrinsic" height="20px" width="20px"
                src="https://imgsaya.io/download/Rv9PWSHi.png" alt="LIVECHAT SLOT RESMI">
            Live Chat
        </a>
    </div>
